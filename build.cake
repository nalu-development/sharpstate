...
Task("Restore")
    ...
    .Does(() =>
    {
        DotNetRestore("Nalu.SharpState.Pack.slnf");
    });
...
Task("Build")
    ...
    .Does(() =>
    {
        ...
        DotNetBuild("Nalu.SharpState.Pack.slnf", settings);
    });

Task("Test")
    .Description("Runs unit tests and outputs test results to the artefacts directory.")
    .DoesForEach(
        GetFiles("./Tests/Nalu.SharpState.Tests/*.csproj"),
        project =>
        {
            DotNetTest(
                project.ToString(),

...
namespace Sample
{
    public static partial class Deep
    {
        ...
        protected interface IStateConfigurator : IStateConfiguration
        {
            ...
            /// </summary>
            /// <param name="configure">Configures the <see cref="global::Nalu.SharpState.ISyncStateTriggerBuilder{global::Sample.Ctx, State, IActor}"/> used by <see cref="IActor.StartEdit()"/>.</param>
            /// <returns>The same configurator for chaining.</returns>
            IStateConfigurator OnStartEdit(Action<global::Nalu.SharpState.ISyncStateTriggerBuilder<global::Sample.Ctx, State, IActor>> configure);
            
            /// <summary>
            /// Configures what happens when <see cref="IActor.Save()"/> is invoked.
            /// </summary>
            /// <param name="configure">Configures the <see cref="global::Nalu.SharpState.ISyncStateTriggerBuilder{global::Sample.Ctx, State, IActor}"/> used by <see cref="IActor.Save()"/>.</param>
            /// <returns>The same configurator for chaining.</returns>
            IStateConfigurator OnSave(Action<global::Nalu.SharpState.ISyncStateTriggerBuilder<global::Sample.Ctx, State, IActor>> configure);
        }
        ...
        public interface IActor
        {
            ...
            /// <summary>
            /// Fires <see cref="Trigger.StartEdit"/> from the current state.
            /// </summary>
            void StartEdit();
        ...
        public static string ToDot() => global::Nalu.SharpState.StateMachineExporter.ToDot(_definition, GetInitialState(), "Deep");
        ...
        public static string ToMermaid() => global::Nalu.SharpState.StateMachineExporter.ToMermaid(_definition, GetInitialState(), "Deep");
        ...
        private sealed class GeneratedStateConfigurator : global::Nalu.SharpState.StateConfigurator<global::Sample.Ctx, State, Trigger, IActor>, IStateConfigurator
        {
            ...
            public IStateConfigurator OnStartEdit(Action<global::Nalu.SharpState.ISyncStateTriggerBuilder<global::Sample.Ctx, State, IActor>> configure)
            {
                var builder = new global::Nalu.SharpState.StateTriggerBuilder<global::Sample.Ctx, State, IActor>();
                configure(builder);
                builder.Validate();
            ...
            public IStateConfigurator OnSave(Action<global::Nalu.SharpState.ISyncStateTriggerBuilder<global::Sample.Ctx, State, IActor>> configure)
            {
                var builder = new global::Nalu.SharpState.StateTriggerBuilder<global::Sample.Ctx, State, IActor>();
                configure(builder);
                builder.Validate();
        ...
        partial class ConnectedRegion
        {
            internal static void __Register(global::Nalu.SharpState.InternalEnumMap<State, global::Nalu.SharpState.IStateConfiguration<global::Sample.Ctx, State, Trigger, IActor>> map)
            {
                ...
                }
                {
                    ...
                    c.ApplyParent(State.Connected);
                    c.ApplyInitialChild(State.Browsing);
                    map[State.Authenticated] = c;
                }
                AuthenticatedRegion.__Register(map);
            }
                ...
                {
                    {
                        ...
                        c.ApplyParent(State.Authenticated);
                        map[State.Browsing] = c;
                    }
                    {
                        var c = (GeneratedStateConfigurator)Editing;
                        c.ApplyParent(State.Authenticated);
                        map[State.Editing] = c;
                    }
                }
